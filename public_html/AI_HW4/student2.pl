...
front(Q,[Q|_]).
between(U,V,W,List) :-iright(U,V,List),iright(V,W,List).
between(U,V,W,List) :-iright(W,V,List),iright(V,U,List).
...
%clue13
\+next_to([olivia,_,_,_,_],[jacob,_,_,_,_],List),
%clue14
...
%clue19
between([emma,_,_,_,_],[olivia,_,_,_,_],[ethan,_,_,_,_],List),
%extra
